...
print B+BL+'#-----------------------------------------#'
print B+W+'[x] masokkan url bloger kelen'
print B+W+'[x] jangan sukak sukak kelen aja masokkan url'
print B+W+'[x] pecah pala kelen nantik kubuat'
print B+W+'[x] kalok kenak bened gak tanggong jawab aku'
print B+W+'[x] semoga kelen makeknya puas ya!..'
print B+BL+'#-----------------------------------------#'
print B+R+'               \!/WARNING\!/'
print B+BL+'#-----------------------------------------#'
